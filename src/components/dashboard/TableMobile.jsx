...
//This TableMobileItem should be a dynamic custom components with an array of props which you can loop through to create the divs. the prop

// const DynamicTableItem = (props) => {
//   return (
//     <>
